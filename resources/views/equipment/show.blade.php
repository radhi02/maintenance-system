            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('equipment.index') }}"> Equipment</a></li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body p-0">
                            <table class="table table-sm">
                                <tbody>
                                    ...
                                    @if(isset($equipment->invoiceFile))
                                    <tr>
                                        <th>Invoicefile</th>
                                        <td>
                                            <a class="mr-2" data-toggle="tooltip" data-placement="bottom"
                                                title="{{$equipment->invoiceFile}}" data-original-title="View"
                                                href="{{ route('donwloadInvoicefile',$equipment->invoiceFile) }}"
                                                target="_blank"><i class="fas fa-download" aria-hidden="true"></i>
                                            </a>
                                        </td>
                                    </tr>
                                    @endif
